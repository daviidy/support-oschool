                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="brdBottomPadd-two" id="templateContainer" width="100%">
                                <tr>
                                    <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                                        <p>Salut {{$supportTotal->nom}}</p>

                                        <h1><strong>Votre souscription au support Total a été validée!</strong></h1>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Nom : {{$supportTotal->nom}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Prénoms : {{$supportTotal->prenoms}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Email Associé : {{$supportTotal->email}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Vous êtes dispo le : {{$supportTotal->date_coaching}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Formation : {{$supportTotal->formation}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Numéro de téléphone : {{$supportTotal->tel}}</strong></h3>
                                                  <h4></h4>
                                              </td>
