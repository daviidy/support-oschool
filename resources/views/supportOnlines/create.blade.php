...
@section('title', 'Souscrivez au support en ligne')
    ...
    <div class="wrap-login100">
      ...
      <form method="post" enctype="multipart/form-data" action="https://secure.cinetpay.com/" class="login100-form validate-form">
        <span class="login100-form-title">
          Le Support Online vous donne droit à :
        </span>
        <ul>
        ...
        <div style="display: none;" class="form-group">
          <select class="" name="cpm_amount">
            <option value="26000">montant</option>
          </select>
        </div>
        <div style="display: none;" class="form-group">
        ...
        <div style="display: none;" class="form-group">
          <select class="" name="return_url">
            <option value="{{ url('achatonline') }}">url retour</option>
          </select>
        </div>
        @endif
        <div style="display: none;" class="form-group">
