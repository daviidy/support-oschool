...
<head>
    ...
    <title>Votre souscription a été validée</title>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" class="content" style="background-color: #FFFFFF">
                    <tr>
                        <td id="templateContainerHeader" valign="top" mc:edit="welcomeEdit-01">
                            <p style="text-align:center;margin:0;padding:0;"><img height="150" src="https://minaci.oschool.ci/edu/nappy.jpeg" style="display:inline-block;"></p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="brdBottomPadd-two" id="templateContainer" width="100%">
                                <tr>
                                    <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                                        <p>Salut {{$supportOnline->nom}}</p>

                                        <h1><strong>Votre souscription au support Online a été validée!</strong></h1>

                                        <h3>Vous serez contacté dans les prochaines 48 heures pour débuter l'accompagnement. <strong>Pour rappel, le
                                        support dure 12 mois, à compter de maintenant. </strong>.</h3>
                                        <p>Voici les informations récapitulatives</p>
                                    </td>
                                </tr>
                                    ...
                                    <td class="bodyContentImage" valign="top">
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="left" style="margin:0;padding-top:10px;line-height:1;" valign="top" mc:edit="welcomeEdit-04">
                                                    <h4><strong>Par Rikudo Technologies</strong></h4>

                                                    <h5>Partenaire du Minaci 2018</h5>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td align="center" class="bodyContentTicks">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                          ...
                                          <tr valign="top">
                                              <td valign="top" mc:edit="welcomeEditImgFirst" style="width:19%;color:#505050;font-family:Helvetica;font-size:14px;padding-bottom:1.143em;">
                                                  <p style="text-align:center;margin:0 0 15px 0;padding:0;">
                                                      <img height="" src="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/templates/circle.jpg" style="display:block;" width="91"></p>
                                              </td>
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Nom : {{$supportOnline->nom}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Prénoms : {{$supportOnline->prenoms}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Email Associé : {{$supportOnline->email}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Vous êtes dispo le : {{$supportOnline->date_coaching}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Formation : {{$supportOnline->formation}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                                                  <h3><strong>Numéro de téléphone : {{$supportOnline->tel}}</strong></h3>
                                                  <h4></h4>
                                              </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" id="templateContainerMiddleBtm" width="100%">
                                <tr>
                                    <td class="bodyContent" valign="top" mc:edit="welcomeEdit-11">
                                        <h3><strong>Continuez toujours d'apprendre avec Oschool !</strong></h3>
                    ...
                    "https://rikudotech.com">Un produit de Rikudo Technologies</a></h6>
                                    </td>
                                </tr>
                            </table>
                        </td>
